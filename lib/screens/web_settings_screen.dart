...
class WebSettingsScreen extends StatelessWidget {
      ...
      child: Column(
        ...
        children: [
          ...
          _section('Plan Details', [
            ...
            _infoRow('Platform', kIsWeb ? 'Web Browser' : 'Desktop'),
          ]),
          ...
          _section('Plateau Breakers', [
            _ruleItem('1. Drop calories by 100 (remove ¼ cup rice from lunch)'),
            _ruleItem('2. Add 10 min cardio to every session'),
            _ruleItem('3. Do 16:8 intermittent fasting day'),
            _ruleItem('4. Add a 4th gym day (Sunday light lifting)'),
            _ruleItem('5. Refeed day: eat at maintenance (1,800 cal), then cut again'),
          ]),
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text('Built with Flutter • Web + Windows + iOS', style: TextStyle(color: Colors.grey[500], fontSize: 12)),
                const SizedBox(height: 4),
                Text(
                  kIsWeb ? 'Data stored in browser localStorage' : 'Data stored locally (SharedPreferences)',
  ...
  static Widget _scheduleRow(String day, String type, String workout) {
    return Padding(
      ...
      child: Row(
        children: [
          SizedBox(width: 90, child: Text(day, style: const TextStyle(color: Colors.white, fontWeight: FontWeight.w600, fontSize: 13))),
          Container(
